...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{url("/setting/creator/add")}}" class="btn btn-primary shadow-md mr-2">New Creator</a>
            <div class="dropdown">
            ...
            @if (app('request')->input('keyword'))
                <a href="{{url('/setting/creator')}}" class="btn px-2 box ml-2" aria-expanded="false" data-tw-toggle="dropdown">
    ...
    <div class="intro-y box p-5 mt-5">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">LTD</th>
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center mt-5">
            ...
            {{$creators->links('pagination::custom-tailwind')}}
        </div>
    </div>
    <div id="success-notification-content" class="toastify-content hidden flex"> <i class="text-success" data-lucide="check-circle"></i>
        <div class="ml-4 mr-4">
            <div class="font-medium">Creator Saved!</div>
            <div class="text-slate-500 mt-1">The creator successfully saved!.</div>
        </div>
    </div>
@endsection
