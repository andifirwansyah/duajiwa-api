...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{url("/theme/create")}}" class="btn btn-primary shadow-md mr-2">Add New Theme</a>
            <div class="dropdown">
            ...
            @if (app('request')->input('keyword'))
                <a href="{{url('/theme')}}" class="btn px-2 box ml-2" aria-expanded="false" data-tw-toggle="dropdown">
    ...
    <div class="intro-y box p-5 mt-5">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Theme Cost</th>
                        <th class="whitespace-nowrap">Selling Price</th>
                ...
                <tbody>
                    @foreach ($themes as $key => $theme)
                        <tr>
                            ...
                            {{-- <td>
                                @if ($theme->published)
                                    <div class="btn px-2 box btn-success-soft">
                                        <i class="w-4 h-4" data-lucide="globe"></i>
                                    </div>
                                @else
                                    <div class="btn px-2 box btn-danger-soft">
                                        <i class="w-4 h-4" data-lucide="power"></i>
                                    </div>
                                @endif
                            </td> --}}
                            <td>
                                <a href="{{$theme->demo_subdomain}}" target="_blank" class="btn btn-success-soft">
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center mt-5">
            ...
            {{$themes->links('pagination::custom-tailwind')}}
        </div>
    </div>
    <div id="success-notification-content" class="toastify-content hidden flex"> <i class="text-success" data-lucide="check-circle"></i>
        <div class="ml-4 mr-4">
            <div class="font-medium">Theme Saved!</div>
            <div class="text-slate-500 mt-1">The theme successfully saved!.</div>
        </div>
    </div>
@endsection
